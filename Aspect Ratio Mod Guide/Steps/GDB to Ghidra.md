...
Press the S key on your keyboard (Search Memory), select Hex and then type the value in Hexadecimal/Hex. In our case this value is: **0x3fe38e3b**. Then click on Search All.
